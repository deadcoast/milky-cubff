...
- [ ] 2. Implement BFF Virtual Machine (vm.py)
  - [ ] 2.1 Create HaltReason enum and RunResult dataclass
  ...
  - [ ] 2.2 Implement BFFVM class initialization
  ...
  - [ ] 2.3 Implement opcode execution logic
  ...
  - [ ] 2.4 Implement dynamic bracket matching
  ...
  - [ ] 2.5 Implement main execution loop with halt conditions
...
- [ ] 3. Implement scheduler (scheduler.py)
  - [ ] 3.1 Create random_disjoint_pairs function
...
- [ ] 4. Implement replication detection (detectors.py)
  - [ ] 4.1 Create ReplicationEvent dataclass
  ...
  - [ ] 4.2 Implement detect_exact_replication function
...
- [ ] 5. Implement analytics (analytics.py)
  - [ ] 5.1 Implement shannon_entropy_bits function
...
- [ ] 7. Implement Soup class (soup.py)
  - [ ] 7.1 Create Soup class initialization
  ...
  - [ ] 7.2 Create PairOutcome dataclass
  ...
  - [ ] 7.4 Implement inject_mutation method
...
- [ ] 8. Implement replicator assay (assay.py)
  - [ ] 8.1 Implement assay_candidate function
...
- [ ] 9. Implement CLI (cli.py)
  - [ ] 9.1 Create argument parser
  ...
  - [ ] 9.2 Implement main simulation loop
    - Create seeded RNG
